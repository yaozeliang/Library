...
urlpatterns = [
    ...
    path(
        "record-create-autocomplete-member-name/", auto_member, name="auto_member_name"
    ),
    ...
    path(
        ...
        BorrowRecordDeleteView.as_view(),
        name="record_delete",
    ),
