...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://github.com/yaozeliang" target="_blank" class="btn btn-md btn-primary">' + '<i class="fa fa-rocket" aria-hidden="true"></i> My Github' +
    '</a> ' + '</div>' + '');
var $window = $(window);
